...
•	Examples:
o	Accepts "TEST@example.com" but converts to lowercase without notifying user
o	No validation for common typos like ".con" instead of ".com"
